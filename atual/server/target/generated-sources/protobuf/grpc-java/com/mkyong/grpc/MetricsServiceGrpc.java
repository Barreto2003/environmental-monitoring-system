...
public final class MetricsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.mkyong.grpc.Metric,
      com.mkyong.grpc.MetricResponse> getSendMetricMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMetric",
      requestType = com.mkyong.grpc.Metric.class,
      responseType = com.mkyong.grpc.MetricResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.mkyong.grpc.Metric,
      com.mkyong.grpc.MetricResponse> getSendMetricMethod() {
    io.grpc.MethodDescriptor<com.mkyong.grpc.Metric, com.mkyong.grpc.MetricResponse> getSendMetricMethod;
      ...
      synchronized (MetricsServiceGrpc.class) {
        if ((getSendMetricMethod = MetricsServiceGrpc.getSendMetricMethod) == null) {
          MetricsServiceGrpc.getSendMetricMethod = getSendMetricMethod =
              io.grpc.MethodDescriptor.<com.mkyong.grpc.Metric, com.mkyong.grpc.MetricResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendMetric"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mkyong.grpc.Metric.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mkyong.grpc.MetricResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sendMetric(com.mkyong.grpc.Metric request,
        io.grpc.stub.StreamObserver<com.mkyong.grpc.MetricResponse> responseObserver) {
  ...
  public static final class MetricsServiceStub
    ...
    /**
     */
    public void sendMetric(com.mkyong.grpc.Metric request,
        io.grpc.stub.StreamObserver<com.mkyong.grpc.MetricResponse> responseObserver) {
  ...
  public static final class MetricsServiceBlockingStub
    ...
    /**
     */
    public com.mkyong.grpc.MetricResponse sendMetric(com.mkyong.grpc.Metric request) {
  ...
  public static final class MetricsServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.mkyong.grpc.MetricResponse> sendMetric(
        com.mkyong.grpc.Metric request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_METRIC:
          serviceImpl.sendMetric((com.mkyong.grpc.Metric) request,
              (io.grpc.stub.StreamObserver<com.mkyong.grpc.MetricResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.mkyong.grpc.Metric,
              com.mkyong.grpc.MetricResponse>(
  ...
  private static abstract class MetricsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.mkyong.grpc.MetricsProto.getDescriptor();
    }
