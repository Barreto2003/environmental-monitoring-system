...
public final class MetricsServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "MetricsService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.Metric,
      com.example.grpc.MetricResponse> getSendMetricMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMetric",
      requestType = com.example.grpc.Metric.class,
      responseType = com.example.grpc.MetricResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.Metric,
      com.example.grpc.MetricResponse> getSendMetricMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.Metric, com.example.grpc.MetricResponse> getSendMetricMethod;
      ...
      synchronized (MetricsServiceGrpc.class) {
        if ((getSendMetricMethod = MetricsServiceGrpc.getSendMetricMethod) == null) {
          MetricsServiceGrpc.getSendMetricMethod = getSendMetricMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.Metric, com.example.grpc.MetricResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendMetric"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.Metric.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.MetricResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sendMetric(com.example.grpc.Metric request,
        io.grpc.stub.StreamObserver<com.example.grpc.MetricResponse> responseObserver) {
  ...
  public static final class MetricsServiceStub
    ...
    /**
     */
    public void sendMetric(com.example.grpc.Metric request,
        io.grpc.stub.StreamObserver<com.example.grpc.MetricResponse> responseObserver) {
  ...
  public static final class MetricsServiceBlockingStub
    ...
    /**
     */
    public com.example.grpc.MetricResponse sendMetric(com.example.grpc.Metric request) {
  ...
  public static final class MetricsServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.MetricResponse> sendMetric(
        com.example.grpc.Metric request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_METRIC:
          serviceImpl.sendMetric((com.example.grpc.Metric) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.MetricResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpc.Metric,
              com.example.grpc.MetricResponse>(
  ...
  private static abstract class MetricsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.MetricsProto.getDescriptor();
    }
